...
GtkWidget* create_main_window(int argc, char *argv[]) {
    ...
    const gchar *css = 
        ...
        "  background-image: none;"
        "  background-color: shade(#2C64F5, 1.08);"
        "  color: #FFFFFF;"
        "}"
        "button.suggested-action:active {"
        "  background-image: none;"
        "  background-color: shade(#2C64F5, 0.92);"
        "  color: #FFFFFF;"
        "}"
    ...
    g_object_set(G_OBJECT(refresh_button), "text", "Refresh", NULL);
    ...
    g_object_set(G_OBJECT(about_button), "text", "About Dodo", NULL);
